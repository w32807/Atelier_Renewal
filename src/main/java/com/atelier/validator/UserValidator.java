...
public class UserValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		...
		try {
			...
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "saAddrHead", "confirm.shipping");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "saAddrDetail", "confirm.shipping");
